...
public static class DriverEndpoints
{
    ...
    /// <summary>The transport stream of one session, chunked and unwrapped.</summary>
    public static string SessionStream(string sessionId) =>
        $"{Sessions}/{sessionId}/stream";

    /// <summary>The fixed paths, for tests and diagnostics.</summary>
    public static readonly IReadOnlyList<string> All = [Health, Tuners, Sessions, Events];
}
