...
namespace Carina.Db.Migrations
{
    ...
    [Migration("20260917144532_WhetherAnEncodeWasAskedFor")]
    partial class WhetherAnEncodeWasAskedFor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Carina.Domain.Channels.CandidateChannel", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Score", "Carina.Domain.Channels.CandidateChannel.Score#CandidateScore", b1 =>
                        {
                            b1.Property<double?>("BitErrorRateHighest")
                                .HasColumnType("double precision")
                                .HasColumnName("score_bit_error_rate_highest");

                            b1.Property<int?>("CarrierToNoiseLowestMilliDecibels")
                                .HasColumnType("integer")
                                .HasColumnName("score_cnr_lowest_milli_decibels");

                            b1.Property<DateTime>("EvaluatedAt")
                                .HasColumnType("timestamp with time zone")
                                .HasColumnName("score_evaluated_at");

                            b1.Property<double>("LockRate")
                                .HasColumnType("double precision")
                                .HasColumnName("score_lock_rate");

                            b1.Property<DateTime>("MeasuredFrom")
                                .HasColumnType("timestamp with time zone")
                                .HasColumnName("score_measured_from");

                            b1.Property<DateTime>("MeasuredUntil")
                                .HasColumnType("timestamp with time zone")
                                .HasColumnName("score_measured_until");

                            b1.Property<long>("Samples")
                                .HasColumnType("bigint")
                                .HasColumnName("score_samples");
                        });
            ...
            modelBuilder.Entity("Carina.Domain.Encodings.EncodeAutoRun", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
                    ...
                    b.Property<bool>("Automatically")
                        .HasColumnType("boolean")
                        .HasColumnName("automatically");

                    b.Property<int>("MostCores")
                        .HasColumnType("integer")
                        .HasColumnName("most_cores");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_encode_auto_run");

                    b.ToTable("encode_auto_run", null, t =>
                        {
                            t.HasCheckConstraint("ck_encode_auto_run_cores", "most_cores >= 1 AND most_cores <= 256");

                            t.HasCheckConstraint("ck_encode_auto_run_single_row", "id = 1");
                        });
                });
            ...
            modelBuilder.Entity("Carina.Domain.Encodings.StationWatermark", b =>
                {
                    b.Property<int>("NetworkId")
                        .HasColumnType("integer")
                        .HasColumnName("network_id");
                    ...
                    b.HasKey("NetworkId", "ServiceId", "LearnedFrom")
                        .HasName("pk_encode_watermark");

                    b.HasIndex("NetworkId", "ServiceId", "LearnedAt")
                        .HasDatabaseName("ix_encode_watermark_learned_at");

                    b.ToTable("encode_watermark", null, t =>
                        {
                            t.HasCheckConstraint("ck_encode_watermark_pattern", "octet_length(pattern) = 16200");

                            t.HasCheckConstraint("ck_encode_watermark_service", "network_id BETWEEN 0 AND 65535 AND service_id BETWEEN 0 AND 65535");
                        });
                });
            ...
            modelBuilder.Entity("Carina.Domain.Integrity.IntegrityFinding", b =>
                {
                    ...
                    b.Property<DateTime?>("ThrownAwayAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("thrown_away_at");
                    ...
                    b.ToTable("integrity_finding", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_integrity_finding_last_written", "last_written_at IS NULL OR fault IN ('NoLedgerRow')");
                            ...
                            t.HasCheckConstraint("ck_integrity_finding_thrown_away", "thrown_away_at IS NULL\nOR (fault IN ('NoLedgerRow') AND last_written_at IS NOT NULL AND thrown_away_at >= noticed_at)");
                        });
                });

            modelBuilder.Entity("Carina.Domain.Migration.MigrationChannelProposal", b =>
                {
                    ...
                    b.Property<string>("RescannedName")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                    ...
                    b.Property<string>("SourcePhysicalChannel")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                    ...
                    b.HasKey("RunId", "NetworkId", "ServiceId")
                        .HasName("pk_migration_channel_proposal");

                    b.ToTable("migration_channel_proposal", null, t =>
                        {
                            t.HasCheckConstraint("ck_migration_channel_proposal_name", "(standing = 'NameProposed') = (rescanned_name IS NOT NULL)");

                            t.HasCheckConstraint("ck_migration_channel_proposal_standing", "standing IN ('NameProposed', 'NothingAnswers', 'Inexpressible')");
                        });
                });

            modelBuilder.Entity("Carina.Domain.Migration.MigrationDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<long?>("Claimed")
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_migration_detail");

                    b.HasIndex("RunId", "Refusal")
                        .HasDatabaseName("ix_migration_detail_run");

                    b.HasIndex("RunId", "Population", "Subject")
                        .IsUnique()
                        .HasDatabaseName("ux_migration_detail_subject");

                    b.ToTable("migration_detail", null, t =>
                        {
                            t.HasCheckConstraint("ck_migration_detail_population", "population IN ('Recordings', 'RecordingFiles', 'Rules', 'Reservations', 'ChannelDefinitions')");

                            t.HasCheckConstraint("ck_migration_detail_refusal", "refusal IN ('ReallyEmpty', 'FileMissing', 'Orphan', 'Unidentifiable', 'Inexpressible', 'NoSuchFeature', 'OutOfScope')");

                            t.HasCheckConstraint("ck_migration_detail_sizes", "(claimed IS NULL OR claimed >= 0) AND (observed IS NULL OR observed >= 0)");

                            t.HasCheckConstraint("ck_migration_detail_subject", "length(subject) > 0");
                        });
                });

            modelBuilder.Entity("Carina.Domain.Migration.MigrationLoss", b =>
                {
                    b.Property<Guid>("RunId")
                        .HasColumnType("uuid")
                        .HasColumnName("run_id");
                    ...
                    b.HasKey("RunId", "Subject")
                        .HasName("pk_migration_loss");

                    b.ToTable("migration_loss", null, t =>
                        {
                            t.HasCheckConstraint("ck_migration_loss_affected", "affected >= 0");

                            t.HasCheckConstraint("ck_migration_loss_subject", "subject IN ('DuplicateAvoidance', 'EnclosedCharacters', 'DayBoundary')");
                        });
                });

            modelBuilder.Entity("Carina.Domain.Migration.MigrationRuleProposal", b =>
                {
                    b.Property<Guid>("RunId")
                        .HasColumnType("uuid")
                        .HasColumnName("run_id");

                    b.Property<long>("SourceRow")
                        .HasColumnType("bigint")
                        .HasColumnName("source_row");

                    b.Property<bool>("EnabledAtTheSource")
                        .HasColumnType("boolean")
                    ...
                    b.HasKey("RunId", "SourceRow")
                        .HasName("pk_migration_rule_proposal");

                    b.ToTable("migration_rule_proposal", null, t =>
                        {
                            t.HasCheckConstraint("ck_migration_rule_proposal_source_row", "source_row > 0");
                        });
                });

            modelBuilder.Entity("Carina.Domain.Migration.MigrationRun", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_migration_run");

                    b.HasIndex("FinishedAt")
                        .HasDatabaseName("ix_migration_run_finished");

                    b.ToTable("migration_run", null, t =>
                        {
                            t.HasCheckConstraint("ck_migration_run_pass", "pass IN ('Rehearsal', 'ForReal')");

                            t.HasCheckConstraint("ck_migration_run_source", "length(source) > 0");

                            t.HasCheckConstraint("ck_migration_run_span", "finished_at >= started_at");
                        });
                });

            modelBuilder.Entity("Carina.Domain.Migration.MigrationStanding", b =>
                {
                    b.Property<Guid>("RunId")
                        .HasColumnType("uuid")
                        .HasColumnName("run_id");
            ...
            modelBuilder.Entity("Carina.Domain.Migration.MigrationTally", b =>
                {
                    b.Property<Guid>("RunId")
                        .HasColumnType("uuid")
                        .HasColumnName("run_id");
                    ...
                    b.Property<int>("NotCarried")
                        .HasColumnType("integer")
                        .HasColumnName("not_carried");

                    b.Property<int>("Offered")
                        .HasColumnType("integer")
                        .HasColumnName("offered");

                    b.Property<int>("Unclassified")
                        .HasColumnType("integer")
                        .HasColumnName("unclassified");

                    b.HasKey("RunId", "Population")
                        .HasName("pk_migration_tally");

                    b.ToTable("migration_tally", null, t =>
                        {
                            t.HasCheckConstraint("ck_migration_tally_counts", "offered >= 0\nAND carried >= 0\nAND not_carried >= 0\nAND unclassified >= 0\nAND carried + not_carried + unclassified = offered");

                            t.HasCheckConstraint("ck_migration_tally_population", "population IN ('Recordings', 'RecordingFiles', 'Rules', 'Reservations', 'ChannelDefinitions')");
                        });
                });
            ...
            modelBuilder.Entity("Carina.Domain.Programmes.ArchivedProgramme", b =>
                {
                    ...
                    b.Property<int>("broadcast_dow")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("integer")
                        .HasColumnName("broadcast_dow")
                        .HasComputedColumnSql("extract(dow from ((start_at AT TIME ZONE INTERVAL '+09:00') - INTERVAL '4 hours'))::integer", true);
            ...
            modelBuilder.Entity("Carina.Domain.Programmes.Programme", b =>
                {
                    ...
                    b.ToTable("programme", null, t =>
                        {
                            t.HasCheckConstraint("ck_programme_aspect", "aspect IN ('Undetermined', 'FourByThree', 'SixteenByNineWithPanVector', 'SixteenByNine', 'WiderThanSixteenByNine')");

                            t.HasCheckConstraint("ck_programme_audio", "audio IN ('Undetermined', 'Mono', 'Stereo', 'DualMono', 'Surround')");

                            t.HasCheckConstraint("ck_programme_runs_forward", "end_at IS NULL OR end_at > start_at");

                            t.HasCheckConstraint("ck_programme_sounds", "sounds >= 0");

                            t.HasCheckConstraint("ck_programme_source", "source IN ('PresentFollowing', 'ScheduleBasic', 'ScheduleExtended')");

                            t.HasCheckConstraint("ck_programme_video", "video IN ('Undetermined', 'Progressive180', 'Progressive240', 'Interlaced480', 'Progressive480', 'Progressive720', 'Interlaced1080', 'Progressive1080', 'Progressive2160', 'Progressive4320')");
                        });
                });
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Signal", "Carina.Domain.Quality.QualitySignalSample.Signal#SignalSample", b1 =>
                        {
                            ...
                            b1.Property<string>("NotTakenBecause")
                                .HasMaxLength(32)
                                .HasColumnType("character varying(32)")
                    ...
                    b.ToTable("quality_signal_sample", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_quality_signal_sample_not_taken", "(not_taken_because IS NULL OR not_taken_because IN ('DriverUnreachable', 'NothingReported', 'NoTimeGiven', 'FiguresRefused'))\nAND (\n    not_taken_because IS NULL\n    OR (\n        NOT locked\n        AND cnr_milli_decibels IS NULL\n        AND bit_errors = '[]'::jsonb\n        AND metrics_not_read = '[]'::jsonb\n    )\n)");
            ...
            modelBuilder.Entity("Carina.Domain.Quality.QualityThresholdChange", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_quality_threshold_change");

                    b.HasIndex("Key", "ChangedAt")
                        .HasDatabaseName("ix_quality_threshold_change_history");
            ...
            modelBuilder.Entity("Carina.Domain.Recordings.Recording", b =>
                {
                    ...
                    b.Property<int?>("FilesLeftBehind")
                        .HasColumnType("integer")
                        .HasColumnName("files_left_behind");
                    ...
                    b.Property<DateTime?>("LeftBehindAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("left_behind_at");
                    ...
                    b.Property<string>("SnapshotAudio")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasColumnName("snapshot_audio");
                    ...
                    b.Property<int>("SnapshotSounds")
                        .HasColumnType("integer")
                        .HasColumnName("snapshot_sounds");
                    ...
                    b.ToTable("recording", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_recording_history", "recording_history_holds(interruptions, resume_count, ARRAY['TuneFailed', 'RefusedByDiskPrecheck', 'DiskExhausted', 'DriverLost', 'DrainGraceExpired', 'StoppedByHand', 'TunerContended', 'ScramblingUnresolved', 'LeftRunningUnwatched', 'DriverReplaced']::text[], started_at_actual)");

                            t.HasCheckConstraint("ck_recording_identifiers", "network_id BETWEEN 0 AND 65535\nAND service_id BETWEEN 0 AND 65535\nAND event_id BETWEEN 1 AND 65534");

                            t.HasCheckConstraint("ck_recording_left_behind", "(files_left_behind IS NULL OR left_behind_at IS NOT NULL)\nAND (files_left_behind IS NULL OR files_left_behind > 0)\nAND (left_behind_at IS NULL OR recording_outcome IS NOT NULL)\nAND (left_behind_at IS NULL OR left_behind_at >= started_at_actual)");
                            ...
                            t.HasCheckConstraint("ck_recording_snapshot_audio", "snapshot_audio IN ('Undetermined', 'Mono', 'Stereo', 'DualMono', 'Surround')");

                            t.HasCheckConstraint("ck_recording_snapshot_sounds", "snapshot_sounds >= 0");
                    ...
                    b.ToTable("reservation", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_reservation_snapshot_audio", "snapshot_audio IN ('Undetermined', 'Mono', 'Stereo', 'DualMono', 'Surround')");

                            t.HasCheckConstraint("ck_reservation_snapshot_sounds", "snapshot_sounds >= 0");
            ...
            modelBuilder.Entity("Carina.Domain.Viewing.PlaybackPosition", b =>
                {
                    b.Property<Guid>("RecordingId")
                        .HasColumnType("uuid")
                        .HasColumnName("recording_id");
                    ...
                    b.HasKey("RecordingId", "Viewer")
                        .HasName("pk_playback_position");

                    b.ToTable("playback_position", null, t =>
                        {
                            t.HasCheckConstraint("ck_playback_position_position", "position_ms >= 0");

                            t.HasCheckConstraint("ck_playback_position_subject", "subject <> ''");
                        });
                });
            ...
            modelBuilder.Entity("Carina.Domain.Migration.MigrationChannelProposal", b =>
                {
                    b.HasOne("Carina.Domain.Migration.MigrationRun", null)
                        .WithMany()
                        .HasForeignKey("RunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_migration_channel_proposal_migration_run_run_id");
                });
            ...
            modelBuilder.Entity("Carina.Domain.Migration.MigrationDetail", b =>
                {
                    b.HasOne("Carina.Domain.Migration.MigrationRun", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_migration_detail_migration_run_run_id");
                });
            ...
            modelBuilder.Entity("Carina.Domain.Migration.MigrationLoss", b =>
                {
                    b.HasOne("Carina.Domain.Migration.MigrationRun", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_migration_loss_migration_run_run_id");
                });
            ...
            modelBuilder.Entity("Carina.Domain.Migration.MigrationRuleProposal", b =>
                {
                    b.HasOne("Carina.Domain.Migration.MigrationRun", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_migration_rule_proposal_migration_run_run_id");
                });
            ...
            modelBuilder.Entity("Carina.Domain.Migration.MigrationStanding", b =>
                {
                    b.HasOne("Carina.Domain.Migration.MigrationRun", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_migration_standing_migration_run_run_id");
                });
            ...
            modelBuilder.Entity("Carina.Domain.Migration.MigrationTally", b =>
                {
                    b.HasOne("Carina.Domain.Migration.MigrationRun", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_migration_tally_migration_run_run_id");
                });
