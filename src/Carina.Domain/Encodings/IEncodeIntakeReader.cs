...
/// whatever became of one: the oldest start first, and at most as many as asked for. A recording
/// leaves this list the moment a job is queued for it, so a recording that ends after the ones
/// beside it is found wherever its start puts it.
/// </summary>
