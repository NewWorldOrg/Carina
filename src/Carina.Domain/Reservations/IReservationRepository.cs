...
/// and whether that recording is <see cref="Recordings.Recording.LeftScrambled"/>. The claim and the outcome on the reservation are the recording ledger's to write, so a claim that
