...
/// <summary>
/// Names a session in the session list and in the request that ends it: the SHA-256 of its session id,
/// which cannot be turned back into the id the cookie carries.
/// </summary>
