...
public sealed class EncodePlacesTests
{
    ...
    [Fact(DisplayName = "a recording is read from under the root the driver wrote it into")]
    ...
    [Fact(DisplayName = "an artefact goes under a root this process holds for writing, and never under one it reads from")]
    ...
    [Fact(DisplayName = "work goes beside the artefact unless one directory is named for every root")]
