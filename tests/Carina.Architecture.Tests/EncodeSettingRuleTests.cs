...
public sealed class EncodeSettingRuleTests
{
    ...
    [
        ...
        "/Carina.Domain/Encodings/ChapterReading.cs ChapterReading.Verdict ChapterVerdict",
        ...
        "/Carina.Domain/Encodings/EncodeAutoRun.cs EncodeAutoRun.Automatically bool",
        "/Carina.Domain/Encodings/EncodeAutoRun.cs EncodeAutoRun.Id int",
        "/Carina.Domain/Encodings/EncodeAutoRun.cs EncodeAutoRun.MostCores int",
        "/Carina.Domain/Encodings/EncodeAutoRun.cs EncodeAutoRun.UpdatedAt DateTime",
        "/Carina.Domain/Encodings/EncodeAutoRun.cs EncodeAutoRunStanding.Automatically bool",
        "/Carina.Domain/Encodings/EncodeAutoRun.cs EncodeAutoRunStanding.MostCores int",
        "/Carina.Domain/Encodings/EncodeAutoRun.cs EncodeAutoRunStanding.Stored bool",
        "/Carina.Domain/Encodings/EncodeAutoRun.cs EncodeAutoRunStanding.UpdatedAt DateTime?",
        "/Carina.Domain/Encodings/EncodeChapter.cs EncodeChapter.EndsAt TimeSpan",
        "/Carina.Domain/Encodings/EncodeChapter.cs EncodeChapter.Id EncodeChapterId",
        "/Carina.Domain/Encodings/EncodeChapter.cs EncodeChapter.JobId EncodeJobId",
        "/Carina.Domain/Encodings/EncodeChapter.cs EncodeChapter.Kind ChapterKind",
        "/Carina.Domain/Encodings/EncodeChapter.cs EncodeChapter.Ordinal int",
        "/Carina.Domain/Encodings/EncodeChapter.cs EncodeChapter.StartsAt TimeSpan",
        ...
        "/Carina.Domain/Encodings/EncodeDestination.cs EncodeDestination.RetiredAt DateTime?",
        ...
        "/Carina.Domain/Encodings/EncodeHeadway.cs EncodeHeadway.At DateTime",
        "/Carina.Domain/Encodings/EncodeHeadway.cs EncodeHeadway.Left TimeSpan?",
        "/Carina.Domain/Encodings/EncodeHeadway.cs EncodeHeadway.Portion double?",
        ...
        "/Carina.Domain/Encodings/EncodeJob.cs EncodeJob.Chapters ChapterReading?",
        ...
        "/Carina.Domain/Encodings/EncodeJob.cs EncodeJob.Route EncodeRoute?",
        ...
        "/Carina.Domain/Encodings/EncodeJob.cs EncodeJob.Timeline EncodeTimeline?",
        ...
        "/Carina.Domain/Encodings/EncodeProfile.cs EncodeProfile.RetiredAt DateTime?",
        ...
        "/Carina.Domain/Encodings/EncodeSpell.cs EncodeSpell.EndedAt DateTime",
        "/Carina.Domain/Encodings/EncodeSpell.cs EncodeSpell.Took TimeSpan",
        "/Carina.Domain/Encodings/EncodeSpell.cs EncodeSpells.Average TimeSpan?",
        "/Carina.Domain/Encodings/EncodeSpell.cs EncodeSpells.Counted int",
        "/Carina.Domain/Encodings/EncodeSpell.cs EncodeSpells.Newest DateTime?",
        "/Carina.Domain/Encodings/EncodeSpell.cs EncodeSpells.Oldest DateTime?",
        ...
        "/Carina.Domain/Encodings/EncodeTimeline.cs EncodeTimeline.SourceStart TimeSpan",
        "/Carina.Domain/Encodings/EncodeUnasked.cs EncodeUnasked.Destination EncodeDestination?",
        "/Carina.Domain/Encodings/EncodeUnasked.cs EncodeUnasked.Profile EncodeProfile?",
        "/Carina.Domain/Encodings/EncodeUnasked.cs EncodeUnasked.Standing EncodeUnaskedStanding",
        ...
        "/Carina.Domain/Encodings/IEncodeJobRepository.cs EncodeHold.Any bool",
        "/Carina.Domain/Encodings/IEncodeJobRepository.cs EncodeHold.Unfinished EncodeJob?",
        "/Carina.Domain/Encodings/IRecordingEncodes.cs EncodesErased.FilesRemoved int",
        "/Carina.Domain/Encodings/IRecordingEncodes.cs EncodesErased.Left IReadOnlyList<EncodeFileName>",
        "/Carina.Domain/Encodings/SourceHeadReading.cs SourceHeadReading.ExitCode int?",
        "/Carina.Domain/Encodings/SourceHeadReading.cs SourceHeadReading.Fault SourceHeadFault?",
        "/Carina.Domain/Encodings/SourceHeadReading.cs SourceHeadReading.FirstPicture TimeSpan?",
        "/Carina.Domain/Encodings/SourceHeadReading.cs SourceHeadReading.Note string",
        "/Carina.Domain/Encodings/SourceHeadReading.cs SourceHeadReading.Start TimeSpan?",
    ...
    [
        ...
        "/Carina.Domain/Encodings/ChapterReading.cs ChapterReading.Marks bool",
        ...
        "/Carina.Domain/Encodings/EncodeProfile.cs EncodeProfile.IsRetired bool",
        ...
        "/Carina.Domain/Encodings/EncodeSpell.cs EncodeSpells.CanBeAveraged bool",
        "/Carina.Domain/Encodings/EncodeTimeline.cs EncodeTimeline.CaptionShift TimeSpan",
        "/Carina.Domain/Encodings/EncodeTimeline.cs EncodeTimeline.Drift TimeSpan?",
        "/Carina.Domain/Encodings/EncodeTimeline.cs EncodeTimeline.Expected TimeSpan?",
        "/Carina.Domain/Encodings/EncodeTimeline.cs EncodeTimeline.LengthsAgree bool?",
        "/Carina.Domain/Encodings/EncodeUnasked.cs EncodeUnasked.IsSettled bool",
        "/Carina.Domain/Encodings/IRecordingEncodes.cs EncodesErased.EverythingIsGone bool",
